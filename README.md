...
* The directory `Neurons/trace` contains representative neuron data traced based on fMOST in SWC format.
* The directory `Neurons/300_300μm` contains fMOST data with 300μm isotropic resolution in TIF format.
* The directory `Neurons/all_hx` contains AMIRA software project files for neuron visualization.
